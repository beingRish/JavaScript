const users = [
    {id: '88f24b3a-3825-4237-a0d1-efb6b92d37a4', firstName: 'Sam', lastName: 'Hughes'},
    ...
    {id: '58ale37b-4b15-47c1-b95b-11fe016f7b64', firstName: 'Chester', lastName: 'Flores'},
...
const comments = [
    {userId: '88f24b3a-3825-4237-a0d1-efb6b92d37a4', text: 'Great Job!'},
    ...
    {userId: '58ale37b-4b15-47c1-b95b-11fe016f7b64', text: 'Cool 😙'},
...
const getUserId = users => users.find(user => `${user.firstName} ${user.lastName}` === 'Madison Marshall')
